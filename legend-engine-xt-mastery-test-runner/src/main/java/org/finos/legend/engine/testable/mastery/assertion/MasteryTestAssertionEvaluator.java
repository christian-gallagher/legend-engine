...
package org.finos.legend.engine.testable.mastery.assertion;
...
public class MasteryTestAssertionEvaluator implements TestAssertionEvaluator
{
    private List<Map<String, Object>> result;
//    private Set<String> fieldsToIgnore;

    public MasteryTestAssertionEvaluator(List<Map<String, Object>> result)//, Set<String> fieldsToIgnore)
    {
        this.result = result;
